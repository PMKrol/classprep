...
function install() {
    ...
    echo '#! /bin/bash' > /home/student/Desktop/UGS.sh
    echo 'java -jar /opt/UniversalGcodeSender.jar' >> /home/student/Desktop/UGS.sh

    # Make the script executable
    chmod +x /home/student/Desktop/UGS.sh

    # Make the script undeletable by student user
    sudo chattr +i /home/student/Desktop/UGS.sh
...
function uninstall() {
    ...
    sudo chattr -i /home/student/Desktop/UGS.sh
    rm -f /home/student/Desktop/UGS.sh
