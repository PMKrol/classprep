...
function install() {
    ...
    cd /home/student/Downloads || { echo "Failed to change directory to ~/Downloads"; exit 1; }
    ...
    wget -q https://raw.githubusercontent.com/PMKrol/classprep/refs/heads/main/Dodatek.txt -O /home/student/Desktop/Dodatek.txt
...
function uninstall() {
    ...
    rm -rf /home/student/Arduino/libraries/*
    echo "[$MODULE_NAME] Removed Arduino libraries."

    # Usunięcie pliku Dodatek.txt
    rm /home/student/Desktop/Dodatek.txt
